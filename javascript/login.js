...
function validateLogin() {
    ...
    const correctUsername = "VB13032025";
    const correctPassword = "202503";
    ...
    if (username === correctUsername && password === correctPassword) {
        ...
        if (selectedLanguage === 'vi') {
            window.location.href = "kh.html/home.html"; // Redirect to Vietnamese homepage
        } else if (selectedLanguage === 'en') {
            window.location.href = "kh.html/home.html"; // Redirect to English homepage
        } else if (selectedLanguage === 'km') {
            window.location.href = "kh.html/home.html"; // Redirect to Khmer homepage
        } else {
